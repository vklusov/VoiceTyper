...
### 1. Сервер (выделенный Mac для обработки)
...
- Микрофон (через вебкамеру, гарнитуру или встроенный)
...
|----------|-----------|----------|
| Server Host | (IP сервера) | IP адрес машины с сервером |
| Server Port | 9001 | Порт сервера |
| Whisper Model | large-v3 | small / medium / large-v3 |
| Clean with LLM | выкл | Чистка через Ollama |
| Language | auto | Авто / Русский / English |

## Известные ограничения

- Quality распознавания зависит от микрофона
...
- Некоторые Mac (Mac mini) не имеют встроенного микрофона — требуется внешний
